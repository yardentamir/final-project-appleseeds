...
import { UPDATE_PRODUCT_PATH } from '../routes/routes.constants';
  ...
  return (
    <CardStyled title={title}>
      ...
      <div className="options">
        {id ? <Link className="card-btn" to={`${UPDATE_PRODUCT_PATH}/${id}`}>UPDATE</Link> : <a className="card-btn" target="_blank" rel="noreferrer" href={`https://api.whatsapp.com/send?phone=+972${phone.slice(1)}&text=Hi,%20I%20${title}%20${title === "lost" ? "my" : "your"}%20${type}!`}>CONTACT</a>}
